...
<body>
    <div class="fmtitle">
        ...
        <p>Find your perfect pet or sell your pets to loving homes.<br>
        Explore the <a href="profile.php">User Profile</a> to manage your account<br>
        View pets available for purchase on the <a href="browse_pets.php">Pet Listings</a> page<br>
        Create a new user on <a href="register.html">New User Registration</a>   
        </p>
    </div>     
<section>
